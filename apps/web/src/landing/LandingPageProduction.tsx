          ...
          <div className="lp3-product-stage" id="demo">
            ...
            <div className="lp3-stage-grid">
              <section className="lp3-agent-pane" aria-label="Диалог с агентом">
                <div className="lp3-pane-head"><div className="lp3-agent-avatar"><BotIcon aria-hidden="true" /></div><div><strong>ProSmet AI</strong><small>строительный агент</small></div><span className="lp3-live">готов</span></div>
