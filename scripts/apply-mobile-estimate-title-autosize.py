...
component = '''function AutoResizeTextarea({
  id,
  name,
  ariaLabel,
  value,
...
new_style = """  .mobile-item-head > input { width: 100%; min-height: 44px; border: 0; background: transparent; padding: 2px 0 0; color: var(--text); font-size: 16px; font-weight: 700; line-height: 1.35; outline: 0; }
  .mobile-item-head > textarea { width: 100%; min-height: 44px; display: block; overflow: hidden; resize: none; border: 0; background: transparent; padding: 2px 0 0; color: var(--text); font-size: 16px; font-weight: 700; line-height: 1.35; outline: 0; }"""
