...
Работа считается опубликованной только после деплоя точного SHA `main` на `https://kolibriai.online`, public health PASS и desktop/mobile браузерного сценария.
